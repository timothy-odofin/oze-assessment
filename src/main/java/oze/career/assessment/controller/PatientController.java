...
public class PatientController {
    ...
    ApiResponse<String> addPatient(@Valid @RequestBody PatientRequest payload) {
    ...
    response = String.class)
    ApiResponse uploadPatient(@RequestParam(STAFF_ID) UUID staffId,
    ...
    ApiResponse<PatientResponseData> fetchPatients(
            @RequestParam(MIN_AGE)
            Integer minAge,
            @RequestParam(STAFF_ID)
            UUID staffId, @RequestParam(value = PAGE, defaultValue = PAGE_DEFAULT) int page,
    ...
    ResponseEntity<Resource> downloadPatient(@RequestParam(MIN_AGE)
                                             Integer minAge,
                                             @RequestParam(STAFF_ID) UUID staffId, @RequestParam(value = PAGE, defaultValue = PAGE_DEFAULT) int page,
                                             @RequestParam(value = SIZE, defaultValue = SIZE_DEFAULT) int size) {
    ...
    ApiResponse<String> deletePatient(@RequestParam(STAFF_ID) UUID staffId,
    ...
    ResponseEntity<Resource> downloadSinglePatient(@RequestParam(STAFF_ID) UUID staffId,
